    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spell', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='spell_casts', to='test_app.spell')),
            ],
            options={
                'ordering': ('-updated_at',),
                'get_latest_by': 'updated_at',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.FileField(blank=True, null=True, upload_to=test_app.storage.StoragePath._media_thumb_upload)),
                ('extra_picture', models.FileField(blank=True, null=True, upload_to=test_app.storage.StoragePath._preserve_name_upload)),
                ('received_letter_at', models.DateTimeField(blank=True, null=True)),
                ('house', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wizards', to='test_app.house')),
                ('spells', models.ManyToManyField(related_name='wizards', through='test_app.SpellCast', to='test_app.Spell')),
            ],
            options={
                'ordering': ('-updated_at',),
                'get_latest_by': 'updated_at',
        ...
        migrations.CreateModel(
            name='CombatSpell',
            fields=[
                ('spell_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='test_app.spell')),
        ...
        migrations.CreateModel(
            name='Teacher',
            fields=[
                ('wizard_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='test_app.wizard')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('name', models.CharField(max_length=50)),
                ('holder', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='wands', to='test_app.wizard')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('order', models.PositiveIntegerField(blank=True, db_index=True, default=None, null=True, verbose_name='order')),
                ('year', models.IntegerField()),
                ('prize', models.CharField(max_length=100)),
                ('wizard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='placements', to='test_app.wizard')),
            ],
            options={
                'ordering': ['year', 'order'],
                'get_latest_by': 'updated_at',
        ...
        migrations.AddField(
            ...
            name='wizard',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='spell_casts', to='test_app.wizard'),
        ),
        migrations.CreateModel(
            name='Patronus',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memories', to='test_app.wizard')),
            ],
            options={
                'ordering': ('-updated_at',),
                'get_latest_by': 'updated_at',
